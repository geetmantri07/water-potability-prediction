...
FILE_NAME: str = "water_potability.csv"
...
# ✅ Updated Best Parameters from MLflow
MODEL_TRAINER_N_ESTIMATORS: int = 50
...
MODEL_BUCKET_NAME = "waterbucket0711"
